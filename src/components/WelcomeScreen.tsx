    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed max-w-2xl mx-auto">
          Find your perfect match through the ancient wisdom of astrology. 
          <span className="text-purple-400 font-semibold"> Discover cosmic compatibility</span> 
          {' '}based on birth charts and celestial alignments.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12 max-w-3xl mx-auto">
          <div className="card-cosmic text-center">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Birth Chart Profile</h3>
            <p className="text-gray-400 text-sm">Create your cosmic profile with birth details</p>
          </div>
          ...
          <div className="card-cosmic text-center">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Cosmic Compatibility</h3>
            <p className="text-gray-400 text-sm">AI-powered astrological matching algorithm</p>
          </div>
          ...
          <div className="card-cosmic text-center">
            ...
            <p className="text-gray-400 text-sm">Chat with astrologically compatible matches</p>
          </div>
        </div>
